        ...
        <div className="border-b border-slate-200/80 bg-white">
          <div className="mx-auto max-w-4xl px-4 py-10 text-center">
            <h1 className="text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">
              شركاء دورلي | دليل الشركات العقارية الموثوقة
            </h1>
            <p className="mt-2 text-sm text-slate-600">
              استكشف أفضل شركات وبراندات العقارات في مصر — شركاء دورلي الموثوقين
            </p>
            <div className="mx-auto mt-6 max-w-md">
              ...
              <input
                ...
                placeholder="ابحث باسم الشركة أو البراند…"
        ...
        <div className="mx-auto max-w-4xl px-4 py-10">
          {filtered.length === 0 ? (
            <p className="rounded-2xl border border-dashed border-slate-200 bg-white py-16 text-center text-slate-600">
              {initial.length === 0
                ? "لا توجد شركات معتمدة في الدليل حالياً."
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1 text-right">
                      ...
                      {a.bio ? (
                        ...
                        <p className="mt-1 text-xs text-slate-400">عرض الصفحة العقارية</p>
                      )}
                    </div>
